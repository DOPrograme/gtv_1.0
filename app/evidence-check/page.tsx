      ...
      <main className="container mx-auto flex-1 px-6 py-12">
        <form onSubmit={handleSubmit}>
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col items-center">
              <div
                ...
                } rounded-lg p-8 w-full aspect-square flex flex-col items-center justify-center text-center cursor-pointer`}
          ...
          <div className="flex justify-end mt-8">
            <Button
              type="submit"
              className="bg-gray-500 hover:bg-gray-600 text-white rounded-full px-12"
